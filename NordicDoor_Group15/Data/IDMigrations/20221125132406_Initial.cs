        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TeamNumber = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Memberships", x => new { x.TeamID, x.UserID });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "varchar(180)", maxLength: 180, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MainBody = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photo_Suggestions_SuggestionID",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuggestionPhotos", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SuggestionPhotos_Suggestions_SuggestionID",
                        column: x => x.SuggestionID,
                        principalTable: "Suggestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuggestionThumbnails", x => x.ID);
                    table.ForeignKey(
                        name: "FK_SuggestionThumbnails_Suggestions_SuggestionID",
                        column: x => x.SuggestionID,
                        principalTable: "Suggestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UploadedFiles_Suggestions_SuggestionID",
                        column: x => x.SuggestionID,
                        principalTable: "Suggestions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuggestionPhotos_SuggestionID",
                table: "SuggestionPhotos",
                column: "SuggestionID",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuggestionThumbnails_SuggestionID",
                table: "SuggestionThumbnails",
                column: "SuggestionID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UploadedFiles_SuggestionID",
                table: "UploadedFiles",
                column: "SuggestionID");
        }
