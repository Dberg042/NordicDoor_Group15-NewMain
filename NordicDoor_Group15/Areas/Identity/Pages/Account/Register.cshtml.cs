...
namespace NordicDoor_Group15.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = CreateUser();
                //user class extra atributes
                user.EmployeeNumber = Input.EmployeeNumber;
                user.FirstName = Input.FirstName;
                user.LastName = Input.LastName;
                //we define here employeenumber as a username
                ...
                if (result.Succeeded)
                {
                    ...
                    //this chunk of code give default user role to new registred user.
                    var defaultrole = _roleManager.FindByNameAsync("User").Result;
                    if (defaultrole != null)
                    {
                        IdentityResult roleresult = await _userManager.AddToRoleAsync(user, defaultrole.Name);
                    }
                    //remove if do not want to give default user role
